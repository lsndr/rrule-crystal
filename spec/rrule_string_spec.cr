...
describe RRule::RRuleString do
  describe "build" do
    ...
    it "builds string RRULE:FREQ=MONTHLY;WKST=SU;BYWEEKDAY=MO,SU" do
      rrule = RRule::RRule.new(
      ...
      rrule_string.build.should eq("RRULE:FREQ=MONTHLY;WKST=SU;BYWEEKDAY=MO,SU")
    end

    it "builds string RRULE:FREQ=MONTHLY;WKST=FR;BYMONTH=1,3,4,12" do
      rrule = RRule::RRule.new(
        freq: RRule::Frequency::MONTHLY,
      ...
      rrule_string.build.should eq("RRULE:FREQ=MONTHLY;WKST=FR;BYMONTH=1,3,4,12")
    end

    it "builds string RRULE:FREQ=MONTHLY;WKST=FR;BYMONTH=10,1;BYSETPOS=3,14" do
      rrule = RRule::RRule.new(
        freq: RRule::Frequency::MONTHLY,
        wkst: RRule::Weekday::FR,
        by_month: [10_i8, 1_i8],
      ...
      rrule_string.build.should eq("RRULE:FREQ=MONTHLY;WKST=FR;BYMONTH=10,1;BYSETPOS=3,14")
    end

    it "builds string RRULE:FREQ=MINUTELY;WKST=MO;BYMONTHDAY=10,15,30" do
      rrule = RRule::RRule.new(
      ...
      rrule_string.build.should eq("RRULE:FREQ=MINUTELY;WKST=MO;BYMONTHDAY=10,15,30")
    end

    it "builds string RRULE:FREQ=SECONDLY;WKST=MO;BYYEARDAY=100,300" do
      rrule = RRule::RRule.new(
        freq: RRule::Frequency::SECONDLY,
        by_year_day: [100, 300]
      )
      ...
      rrule_string.build.should eq("RRULE:FREQ=SECONDLY;WKST=MO;BYYEARDAY=100,300")
    end

    it "builds string RRULE:FREQ=WEEKLY;WKST=MO;BYWEEKNO=4,40,30" do
      rrule = RRule::RRule.new(
        freq: RRule::Frequency::WEEKLY,
        by_week_no: [4, 40, 30]
      )
      ...
      rrule_string.build.should eq("RRULE:FREQ=WEEKLY;WKST=MO;BYWEEKNO=4,40,30")
    end

    it "builds string RRULE:FREQ=WEEKLY;WKST=MO;BYHOUR=2,12;BYMINUTE=30,59;BYSECOND=10,30" do
      rrule = RRule::RRule.new(
        freq: RRule::Frequency::WEEKLY,
        by_hour: [2, 12],
        by_minute: [30, 59],
      ...
      rrule_string.build.should eq("RRULE:FREQ=WEEKLY;WKST=MO;BYHOUR=2,12;BYMINUTE=30,59;BYSECOND=10,30")
    end
  end
end
